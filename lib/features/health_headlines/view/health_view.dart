...
class HealthHeadlineView extends StatefulWidget {
  const HealthHeadlineView({Key? key}) : super(key: key);

  @override
  State<HealthHeadlineView> createState() => _HealthHeadlineViewState();
}

class _HealthHeadlineViewState extends State<HealthHeadlineView> {
  @override
...
Widget NewsBoxes(BuildContext context) {
  final controller = Get.find<HealthHeadlineController>();
  return Obx(() {
