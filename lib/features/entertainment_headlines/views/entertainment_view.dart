...
import 'package:news_app/features/entertainment_headlines/controllers/entertainment_controller.dart';

import '../../article/article_page.dart';

class EntertainmentHeadlinesView extends StatefulWidget {
  const EntertainmentHeadlinesView({Key? key}) : super(key: key);

  @override
  State<EntertainmentHeadlinesView> createState() =>
      _EntertainmentHeadlinesViewState();
}

class _EntertainmentHeadlinesViewState
    extends State<EntertainmentHeadlinesView> {
  @override
  ...
  Widget NewsBoxes(BuildContext context) {
    final controller = Get.find<EntertainmentHeadlineController>();
    return Obx(() {
