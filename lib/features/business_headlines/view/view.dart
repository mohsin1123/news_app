...
class BusinessHeadlines extends StatefulWidget {
  const BusinessHeadlines({Key? key}) : super(key: key);

  @override
  State<BusinessHeadlines> createState() => _BusinessHeadlinesState();
}

class _BusinessHeadlinesState extends State<BusinessHeadlines> {
  @override
  ...
  Widget NewsBoxes(BuildContext context) {
    final controller = Get.find<BusinessHeadlineController>();
    return Obx(() {
