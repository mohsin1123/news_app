...
class SportsHeadlinesView extends StatefulWidget {
  const SportsHeadlinesView({Key? key}) : super(key: key);

  @override
  State<SportsHeadlinesView> createState() => _SportsHeadlinesViewState();
}

class _SportsHeadlinesViewState extends State<SportsHeadlinesView> {
  @override
...
Widget NewsBoxes(BuildContext context) {
  final controller = Get.find<SportsHeadlineController>();
  return Obx(() {
